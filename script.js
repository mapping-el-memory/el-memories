...
var dataset1 = [
  ...
  featurePt('Gungun — Baker Hall', -84.47389, 42.72917, '2023/09',
    'Baker Hall (source: topoquest.com)',
    'https://upload.wikimedia.org/wikipedia/commons/6/6e/East_Lansing_placeholder.jpg',
    'https://en.wikipedia.org/wiki/Michigan_State_University'),
  featurePt('Ritesh — Wells Hall', -84.48194, 42.72778, '2023/09',
    'Wells Hall (source: LatLong)',
    'https://upload.wikimedia.org/wikipedia/commons/6/6e/East_Lansing_placeholder.jpg',
    'https://en.wikipedia.org/wiki/Wells_Hall'),
  featurePt('Gungun — Potbelly (233 E Grand River Ave)', -84.48174, 42.73489, '2023/09',
    'Potbelly (source: MapQuest)',
    'https://upload.wikimedia.org/wikipedia/commons/6/6e/East_Lansing_placeholder.jpg',
  ...
  featurePt('Ritesh — Summit Comics & Games (216 S Washington Sq)', -84.551557, 42.734973, '2023/09',
    'Summit Comics & Games (downtownlansing.org)',
    'https://upload.wikimedia.org/wikipedia/commons/6/6e/East_Lansing_placeholder.jpg',
    'https://en.wikipedia.org/wiki/Lansing,_Michigan'),
  featurePt('Gungun — Jolly Pumpkin (218 Albert Ave)', -84.48253, 42.73586, '2023/09',
    'Jolly Pumpkin (MapQuest)',
    'https://upload.wikimedia.org/wikipedia/commons/6/6e/East_Lansing_placeholder.jpg',
    'https://en.wikipedia.org/wiki/East_Lansing,_Michigan'),
  featurePt('Ritesh — MSU Tech Store (450 Auditorium Rd)', -84.47899, 42.72529, '2023/09',
    'MSU Tech Store (maps.msu.edu)',
    'https://upload.wikimedia.org/wikipedia/commons/6/6e/East_Lansing_placeholder.jpg',
    'https://tech.msu.edu'),
  // 2024
  featurePt('Kiera — IM West', -84.487943, 42.728184, '2024/09',
    'IM West (spartancash.msu.edu)',
    'https://upload.wikimedia.org/wikipedia/commons/6/6e/East_Lansing_placeholder.jpg',
    'https://en.wikipedia.org/wiki/Michigan_State_University'),
  featurePt('Kiera — MSU Dairy Store (474 S Shaw Ln)', -84.479515, 42.725117, '2024/09',
    'MSU Dairy Store (whereorg.com)',
    'https://upload.wikimedia.org/wikipedia/commons/6/6e/East_Lansing_placeholder.jpg',
    'https://en.wikipedia.org/wiki/Michigan_State_University_Dairy_Store'),
  featurePt('Kiera — Main Library (366 W Circle Dr)', -84.483208, 42.730869, '2024/09',
    'Main Library (LatLong)',
    'https://upload.wikimedia.org/wikipedia/commons/6/6e/East_Lansing_placeholder.jpg',
    'https://lib.msu.edu/'),
  featurePt('Kiera — Brody Square', -84.49543, 42.73149, '2024/09',
    'Brody Square (Mapcarta)',
    'https://upload.wikimedia.org/wikipedia/commons/6/6e/East_Lansing_placeholder.jpg',
    'https://en.wikipedia.org/wiki/Brody_Complex'),
  featurePt('Kiera — Erickson Hall', -84.47928, 42.72708, '2024/09',
    'Erickson Hall (Mapcarta)',
    'https://upload.wikimedia.org/wikipedia/commons/6/6e/East_Lansing_placeholder.jpg',
    'https://education.msu.edu/rooms/erickson-hall/')
];
